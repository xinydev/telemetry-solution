...
To modify data size, change the define for `STREAM_ARRAY_SIZE` such that three double arrays fit within in the sum of total L2 cache and shared cache. Example: 

```
STREAM_ARRAY_SIZE = (Total_L2_B + (2*Total_SLC_B/3) ) / 24)
```
